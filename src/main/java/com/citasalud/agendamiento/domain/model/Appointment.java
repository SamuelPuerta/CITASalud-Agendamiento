...
public class Appointment {
    ...
    public Appointment(UUID professionalId, UUID siteId, UUID affiliateId, OffsetDateTime startAt, OffsetDateTime endAt, String status, UUID availableSlotInstanceId) {
        ...
        this.endAt = endAt;
        this.status = status;
        this.availableSlotInstanceId = availableSlotInstanceId;
    }
